...
<a class="button" on:click={toggleMenu}>
    <svg class="menu_svg" viewBox="0 0 100 100" width="30" height="30">
        <rect x="15" y="25" rx="5" width="70" height="10" fill="#fff" />
        <rect x="15" y="45" rx="5" width="70" height="10" fill="#fff" />
        <rect x="15" y="65" rx="5" width="70" height="10" fill="#fff" />
    </svg>
